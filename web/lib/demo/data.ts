...
export const DEMO_PRODUCTS: Product[] = [
  { id: 'p-01', categoryId: 'cat-1', name: 'Bruschetta de Tomate',    description: 'Pão italiano com tomate e manjericão',     price: 24.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1572695157366-5e585ab2b69f?w=400&q=80',  category: { id: 'cat-1', name: 'Entradas' } },
  { id: 'p-02', categoryId: 'cat-1', name: 'Bolinho de Bacalhau (8)', description: 'Fritos com maionese de ervas',             price: 32.00, available: true,  imageUrl: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=400&q=80',  category: { id: 'cat-1', name: 'Entradas' } },
  { id: 'p-03', categoryId: 'cat-1', name: 'Tábua de Frios',         description: 'Queijos, frios e antepastos',              price: 48.00, available: true,  imageUrl: 'https://images.unsplash.com/photo-1506368249639-73a05d6f6488?w=400&q=80',  category: { id: 'cat-1', name: 'Entradas' } },
  { id: 'p-04', categoryId: 'cat-2', name: 'Filé ao Molho Madeira',  description: 'Filé mignon grelhado com batata e arroz',  price: 58.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=400&q=80',  category: { id: 'cat-2', name: 'Pratos Principais' } },
  { id: 'p-05', categoryId: 'cat-2', name: 'Frango Grelhado',        description: 'Peito de frango com legumes',              price: 42.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?w=400&q=80',  category: { id: 'cat-2', name: 'Pratos Principais' } },
  { id: 'p-06', categoryId: 'cat-2', name: 'Moqueca de Camarão',     description: 'Camarão, leite de coco, dendê e arroz',   price: 74.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400&q=80',  category: { id: 'cat-2', name: 'Pratos Principais' } },
  { id: 'p-07', categoryId: 'cat-2', name: 'Risoto de Funghi',       description: 'Arroz arbóreo com cogumelos secos',        price: 52.90, available: false,  imageUrl: 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=400&q=80', category: { id: 'cat-2', name: 'Pratos Principais' } },
  { id: 'p-08', categoryId: 'cat-3', name: 'Margherita',             description: 'Molho, mussarela e manjericão',            price: 45.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=400&q=80',  category: { id: 'cat-3', name: 'Pizzas' } },
  { id: 'p-09', categoryId: 'cat-3', name: 'Calabresa',              description: 'Calabresa fatiada e cebola',              price: 42.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?w=400&q=80',  category: { id: 'cat-3', name: 'Pizzas' } },
  { id: 'p-10', categoryId: 'cat-3', name: 'Frango com Catupiry',    description: 'Frango desfiado e catupiry',               price: 48.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400&q=80',  category: { id: 'cat-3', name: 'Pizzas' } },
  { id: 'p-11', categoryId: 'cat-3', name: 'Quatro Queijos',         description: 'Mussarela, provolone, gorgonzola, parmesão',price: 52.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1571997478779-2adcbbe9ab2f?w=400&q=80',  category: { id: 'cat-3', name: 'Pizzas' } },
  { id: 'p-12', categoryId: 'cat-4', name: 'Classic Burger',         description: 'Hambúrguer 180g, queijo, alface, tomate', price: 32.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80',  category: { id: 'cat-4', name: 'Lanches' } },
  { id: 'p-13', categoryId: 'cat-4', name: 'Smash Bacon',            description: 'Duplo smash, bacon e cheddar',             price: 39.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=400&q=80',  category: { id: 'cat-4', name: 'Lanches' } },
  { id: 'p-14', categoryId: 'cat-4', name: 'Veggie Burger',          description: 'Hambúrguer de grão-de-bico e pesto',       price: 34.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1520072959219-c595dc870360?w=400&q=80',  category: { id: 'cat-4', name: 'Lanches' } },
  { id: 'p-15', categoryId: 'cat-5', name: 'Coca-Cola Lata',         description: '350ml',                                   price:  6.00, available: true,  imageUrl: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=400&q=80',  category: { id: 'cat-5', name: 'Bebidas' } },
  { id: 'p-16', categoryId: 'cat-5', name: 'Suco de Laranja',        description: '400ml natural',                           price: 12.00, available: true,  imageUrl: 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=400&q=80',  category: { id: 'cat-5', name: 'Bebidas' } },
  { id: 'p-17', categoryId: 'cat-5', name: 'Água Mineral',           description: '500ml com ou sem gás',                    price:  5.00, available: true,  imageUrl: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=400&q=80',  category: { id: 'cat-5', name: 'Bebidas' } },
  { id: 'p-18', categoryId: 'cat-5', name: 'Cerveja Artesanal IPA',  description: 'Long neck 355ml',                         price: 18.00, available: true,  imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=400&q=80',  category: { id: 'cat-5', name: 'Bebidas' } },
  { id: 'p-19', categoryId: 'cat-5', name: 'Cerveja Pilsen',         description: 'Lata 350ml',                              price:  8.00, available: true,  imageUrl: 'https://images.unsplash.com/photo-1608270586620-248524c67de9?w=400&q=80',  category: { id: 'cat-5', name: 'Bebidas' } },
  { id: 'p-20', categoryId: 'cat-6', name: 'Petit Gateau',           description: 'Bolo de chocolate quente com sorvete',     price: 22.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1611329532992-0b7af95a3b14?w=400&q=80',  category: { id: 'cat-6', name: 'Sobremesas' } },
  { id: 'p-21', categoryId: 'cat-6', name: 'Pudim de Leite',         description: 'Pudim caseiro com calda de caramelo',      price: 14.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1515467837915-15c4777cd6f0?w=400&q=80',  category: { id: 'cat-6', name: 'Sobremesas' } },
  { id: 'p-22', categoryId: 'cat-6', name: 'Cheesecake de Morango',  description: 'Base de biscoito e calda de morango',      price: 19.90, available: true,  imageUrl: 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=400&q=80',  category: { id: 'cat-6', name: 'Sobremesas' } },
]
