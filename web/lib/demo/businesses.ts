...
const JP_PRODUCTS: Product[] = [
  ...
  jpProduct('jp-p-19', 'jp-cat-6', 'Saquê (dose)',          '100 ml, quente ou gelado',                     14,   { imageUrl: `${IMG}/saque.jpg`, observationOptions: ['Quente', 'Gelado'] }),
  jpProduct('jp-p-20', 'jp-cat-6', 'Água Mineral',          '500 ml com ou sem gás',                        4,    { imageUrl: `${IMG}/agua-mineral.jpg` }),
  jpProduct('jp-p-21', 'jp-cat-7', 'Harumaki de Banana',    'Com canela e sorvete de creme',                18.9, { imageUrl: `${IMG}/harumaki-banana.jpg` }),
  jpProduct('jp-p-22', 'jp-cat-7', 'Mochi (2 un.)',         'Morango ou chá verde',                         16.9, { imageUrl: `${IMG}/mochi.jpg`, observationOptions: ['Morango', 'Chá verde'] }),
]
